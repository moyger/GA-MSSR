"""
Model training and retraining logic for the live bot.

Training pipeline: OHLCV -> denoise -> rule_params -> GA weights -> ModelState.
ModelState is persisted to disk as JSON for fast restarts.
"""
...
class Trainer:
    """Trains the GA-MSSR model from OHLCV data."""
    ...
    def train(self, df: pd.DataFrame) -> ModelState:
        ...
        ----------
        df : pd.DataFrame
            15-min OHLCV data with DatetimeIndex.
            Should contain at least train_days * 96 bars.
        """
